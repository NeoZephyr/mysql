...
CREATE TABLE `heros` (
  ...
  `attack_range` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `role_main` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `role_assist` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
